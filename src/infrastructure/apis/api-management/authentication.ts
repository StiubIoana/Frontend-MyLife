...
export const useLoginApi = () => {
  const loginMutation = (loginDTO: LoginDTO) =>
    new AuthorizationApi().apiAuthorizationLoginPost({ loginDTO }); // Use the generated client code and adapt it.
...
export const useRegisterApi = () => {
  const registerMutation = (registerDTO: RegisterDTO) =>
    new AuthorizationApi().apiAuthorizationRegisterPost({ registerDTO }); // Use the generated client code and adapt it.
