...
export interface ApiUserGetAllUsersGetRequest {
    page?: number;
    pageSize?: number;
}
...
export class UserApi extends runtime.BaseAPI {
    ...
    /**
     */
    async apiUserGetAllUsersGetRaw(requestParameters: ApiUserGetAllUsersGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserDTOPagedResponseRequestResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async apiUserGetAllUsersGet(requestParameters: ApiUserGetAllUsersGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserDTOPagedResponseRequestResponse> {
        const response = await this.apiUserGetAllUsersGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    /**
     */
    async apiUserGetUserCountGetRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Int32RequestResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async apiUserGetUserCountGet(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Int32RequestResponse> {
        const response = await this.apiUserGetUserCountGetRaw(initOverrides);
        return await response.value();
    }
