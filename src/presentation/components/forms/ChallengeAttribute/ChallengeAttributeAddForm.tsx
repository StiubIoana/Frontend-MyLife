...
import { useChallengeAttributeAddFormController } from "./ChallengeAttributeAddForm.controller";
import { isEmpty, isUndefined } from "lodash";

/**
 * Here we declare the ChallengeAttribute add form component.
 * This form may be used in modals so the onSubmit callback could close the modal on completion.
 */
export const ChallengeAttributeAddForm = (props: { onSubmit?: () => void }) => {
    const { formatMessage } = useIntl();
    const { state, actions, computed } = useChallengeAttributeAddFormController(props.onSubmit); // Use the controller.
