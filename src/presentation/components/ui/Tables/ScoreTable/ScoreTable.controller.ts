...
import { useScoreApi } from "@infrastructure/apis/api-management";
 ...
 */
export const useScoreTableController = () => {
  const {
    getScores: { key: queryKey, query },
  } = useScoreApi(); // Use the API hook.
