 ...
 */
export const useChallengeAttributeTableController = (search: string) => {
  const {
    getChallengeAttributes: { key: queryKey, query },
    deleteChallengeAttribute: {
      key: deleteChallengeAttributeKey,
      mutation: deleteChallengeAttribute,
    },
  } = useChallengeAttributeApi(); // Use the API hook.
